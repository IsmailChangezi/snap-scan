...
RSpec.describe Payment, type: :model do
  context 'validation tests' do
    first_user = User.create(name: 'Ismail', email: 'ismailchangezi801@gmail.com', password: 'Password')
    before(:each) do
      first_category = Category.create(name: 'Food', icon: 'icon.jpg', user_id: first_user.id)
      @payment = Payment.create(name: 'mango', amount: 100, author_id: first_user.id,
